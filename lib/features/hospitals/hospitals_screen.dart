...
class _HospitalsScreenState extends State<HospitalsScreen> {
  ...
  Widget _buildMapCarouselView(
    ...
    return Column(
      ...
      children: [
        ...
        // Floating Card Carousel with smooth SlideDown entrance
        SlideDownFade(
  ...
  /// Full List View with Floating Cards over the Interactive Map (Matching Reference Image Right Screen)
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return SlideRightFade(
                delay: Duration(milliseconds: 80 + (index * 60).clamp(0, 300)),
                child: HospitalCard(
                  hospital: hospital,
                  isCompact: true,
                  onDirectionTap: () {
                    state.selectHospital(hospital);
                    _showNavigationModal(context, hospital);
                  },
                  onCallTap: () => _showCallDialer(context, hospital),
                  onMoreTap: () => _showHospitalDetailsModal(context, hospital),
                ),
